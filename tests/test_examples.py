...
EXAMPLES = [
    ...
    "reqdir_missing",
    "reschedule_cap",
    "reschedule_cap_swallowed_error",
    "resource_multi",
    "resource_pool",
    "resource_skip",
    "resource_zero",
    ...
    "static_nglob_partial_break",
    "static_nglob_partial_complete",
    "static_nglob_partial_restart",
    ...
    "wait_first",
    "watch_add_missing",
    "watch_amended_change",
    "watch_amended_delete",
    "watch_amended_restore",
    "watch_awaited",
    "watch_blocked",
    "watch_boot",
    "watch_chain",
