...
behaviour where glob() declared its matches. cat inp.txt > out.txt then has an
UNDECLARED input with no producer, and the build fails loudly, reporting unavailable
inputs,
