...
and will be deferred by the director process until that input becomes available.
...
the step is deferred instead of failing outright.
...
- Deferring a step multiple times.
